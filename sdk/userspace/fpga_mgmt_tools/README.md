...
* `sdacl-slave-timeout-addr` (32-bit)
  * The first address that triggered a `sdacl-slave-timeout-count` event. This is a relative address as the upper bits of the address matching the PCIe BAR are set to zero. (Please see NOTE below.)
...
* `virtual-jtag-slave-timeout-addr` (32-bit)
  * The first address that triggered a `virtual-jtag-slave-timeout-count` event. This is a relative address as the upper bits of the address matching the PCIe BAR are set to zero.(Please see NOTE below.)
...
* `ocl-slave-timeout-addr` (64-bit)
  * The first address that triggered a `ocl-slave-timeout-count` event. This is a relative address as the upper bits of the address matching the PCIe BAR are set to zero. (Please see NOTE below.)
...
* `bar1-slave-timeout-addr` (64-bit)
  * The first address that triggered a `bar1-slave-timeout-count` event. This is a relative address as the upper bits of the address matching the PCIe BAR are set to zero. (Please see NOTE below.)
...
* `dma-pcis-timeout-addr` (64-bit)
  * The first address that triggered a `dma-pcis-timeout-count` event. This is a relative address as the upper bits of the address matching the PCIe BAR are set to zero. (Please see NOTE below.)
