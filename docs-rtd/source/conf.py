...
# NOTE: THIS GUY CONTROLS THE VERSION SHOWN
# release = '2.1'
...
# latex_documents = [
#    ('index', 'F2.tex', 'F2 Documentation', copyright),
# ]
...
# man_pages = [('index', 'f2', 'F2 Documentation', [copyright], 1)]
...
# texinfo_documents = [
#    ('index', 'F2', 'F2 Documentation', copyright, 'AWS EC2 F2 Instance Documentation', 'Miscellaneous'),
# ]
