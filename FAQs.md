...
If you decide to use the [FPGA Developer AMI on AWS Marketplace](https://aws.amazon.com/marketplace/pp/prodview-f5kjsenkfkz5u), Xilinx licenses for simulation, encryption, SDAccel and Design Checkpoint generation are included at no additional cost.
