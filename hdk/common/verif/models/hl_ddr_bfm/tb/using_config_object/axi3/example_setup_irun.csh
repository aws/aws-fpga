...
${CDN_VIP_ROOT}/bin/cdn_vip_setup_env -cdnautotest -s ncsim_irun -cdn_vip_root ${CDN_VIP_ROOT} -m sv_uvm -csh -cdn_vip_lib vip_lib -i axi
...
${CDN_VIP_ROOT}/bin/cdn_vip_setup_example -s ncsim_irun -e ${CDN_VIP_ROOT}/tools/denali/ddvapi/sv/uvm/cdn_axi/examples/using_config_object/axi3 -m sv_uvm -cdn_vip_lib vip_lib -cdnautotest -cdnsvlib
