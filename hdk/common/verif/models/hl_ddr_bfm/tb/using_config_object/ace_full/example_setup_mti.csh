...
${CDN_VIP_ROOT}/bin/cdn_vip_setup_env -cdnautotest -s mti -cdn_vip_root ${CDN_VIP_ROOT} -m sv_uvm -csh
...
${CDN_VIP_ROOT}/bin/cdn_vip_setup_example -s mti -e ${CDN_VIP_ROOT}/tools/denali/ddvapi/sv/uvm/cdn_axi/examples/using_config_object/ace_full -m sv_uvm -cdnautotest -cdnsvlib
