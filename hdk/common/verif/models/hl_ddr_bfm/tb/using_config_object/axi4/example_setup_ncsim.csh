...
${CDN_VIP_ROOT}/bin/cdn_vip_setup_example -s ncsim_3s -e ${CDN_VIP_ROOT}/tools/denali/ddvapi/sv/uvm/cdn_axi/examples/using_config_object/axi4 -m sv_uvm -cdn_vip_lib vip_lib -cdnautotest -cdnsvlib
