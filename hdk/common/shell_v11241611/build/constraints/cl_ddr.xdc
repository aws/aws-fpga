...
set_property PACKAGE_PIN BA33 [get_ports RST_DIMM_D_N]
...
set_property DRIVE 8 [get_ports RST_DIMM_A_N]
...
set_property IOSTANDARD DIFF_SSTL12_DCI [get_ports {M_A_CLK_DP[*]}]
set_property IOSTANDARD DIFF_SSTL12_DCI [get_ports {M_A_CLK_DN[*]}]
...
set_property IOSTANDARD DIFF_SSTL12_DCI [get_ports {M_B_CLK_DP[*]}]
set_property IOSTANDARD DIFF_SSTL12_DCI [get_ports {M_B_CLK_DN[*]}]
