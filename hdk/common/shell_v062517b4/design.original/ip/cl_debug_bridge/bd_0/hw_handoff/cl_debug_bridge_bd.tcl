...
proc create_root_design { parentCell } {
  ...
  set S_BSCAN_VEC [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:bscan_rtl:1.0 S_BSCAN_VEC ]
...
CONFIG.C_XSDB_NUM_SLAVES {0} \
  ...
  connect_bd_intf_net -intf_net S_BSCAN_VEC_1 [get_bd_intf_ports S_BSCAN_VEC] [get_bd_intf_pins lut_buffer/s_bscan_vec]
  connect_bd_intf_net -intf_net lut_buffer_m_bscan_vec [get_bd_intf_pins lut_buffer/m_bscan_vec] [get_bd_intf_pins xsdbm/s_bscan_vec]
