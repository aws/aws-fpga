...
#Searching for Vivado version and comparing it with the list of supported versions
	...
	if { [::tclapp::xilinx::faasutils::make_faas::findLineInFile $AWS_FPGA_REPO_DIR/hdk/supported_vivado_versions.txt $VIVADO_VER] ne "" } {
		...
		puts [::tclapp::xilinx::faasutils::make_faas::findLineInFile $AWS_FPGA_REPO_DIR/hdk/supported_vivado_versions.txt *]
		return 1
	}
