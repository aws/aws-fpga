...
set PWD_DIR $::env(PWD)
set CL_DESIGN_DIR "${PWD_DIR}/../cl_dram_dma/design"
set CL_COMMON_DIR "${PWD_DIR}/../common/design"
set CL_CONST_DIR "${PWD_DIR}/../cl_dram_dma/build/constraints"
set CL_VERIF_DIR "${PWD_DIR}/../cl_dram_dma/verif/tests"
...
set_property verilog_define {CL_NAME=cl_dram_dma TEST_NAME=test_dram_dma} [get_filesets sim_1]
