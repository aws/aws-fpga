...
class S3PolicyChecker:
    ...
    **NOTE**: *The AWS Account ID has changed, please ensure you are using the correct Account ID listed here.*
        ...
        {{
            ...
            "Statement": [
                ...
                {{
                    ...
                    "Resource": "{dcp_resource}"
                }}'''.format(aws_account=aws_account, dcp_bucket_resource=self.dcp_bucket_resource, dcp_resource=self.dcp_resource)
                if self.logs_bucket == self.dcp_bucket:
                    policy_str += ''',
                    {{
    ...
    '''.format(aws_account=aws_account, logs_bucket_resource=self.logs_bucket_resource, logs_resource=self.logs_resource)
                logger.info("The following bucket policy will resolve the problem:\n{0}".format(policy_str))
        return self.num_errors
...
def test():
    ...
    checker = S3PolicyChecker(aws_account_arn, user_account_arn, dcp_bucket, dcp_key, dcp_bucket_policy_notaction_allow_not_s3,
                              logs_bucket, logs_key1, dcp_bucket_policy_notaction_allow_not_s3, user_policy_statments_none)
    checker.check()
    checker.report()
    assert checker.aws_can_list_dcp_bucket == False
    assert checker.aws_cannot_list_dcp_bucket == False
    ...
    checker = S3PolicyChecker(aws_account_arn, user_account_arn, dcp_bucket, dcp_key, dcp_bucket_policy_notaction_deny_not_s3,
                              logs_bucket, logs_key2, dcp_bucket_policy_notaction_deny_not_s3, user_policy_statments_none)
    checker.check()
    checker.report()
    assert checker.aws_can_list_dcp_bucket == False
    assert checker.aws_cannot_list_dcp_bucket == False
    ...
    checker = S3PolicyChecker(aws_account_arn, user_account_arn, dcp_bucket, dcp_key, dcp_bucket_policy_notaction_allow_not_iam,
                              logs_bucket, logs_key1, dcp_bucket_policy_notaction_allow_not_iam, user_policy_statments_none)
    checker.check()
    checker.report()
    assert checker.aws_can_list_dcp_bucket == True
    assert checker.aws_cannot_list_dcp_bucket == False
    ...
    checker = S3PolicyChecker(aws_account_arn, user_account_arn, dcp_bucket, dcp_key, dcp_bucket_policy_notaction_deny_user_not_iam,
                              logs_bucket, logs_key1, dcp_bucket_policy_notaction_deny_user_not_iam, user_policy_statments_none)
    checker.check()
    checker.report()
    assert checker.aws_can_list_dcp_bucket == False
    assert checker.aws_cannot_list_dcp_bucket == False
    ...
    checker = S3PolicyChecker(aws_account_arn, user_account_arn, dcp_bucket, dcp_key, dcp_bucket_policy_allow_aws_dcp_logs,
                              dcp_bucket, logs_key1, dcp_bucket_policy_allow_aws_dcp_logs, user_policy_statments_allow_all)
    checker.check()
    checker.report()
    assert checker.aws_can_list_dcp_bucket == True
    assert checker.aws_cannot_list_dcp_bucket == False
    ...
    checker = S3PolicyChecker(aws_account_arn, user_account_arn, dcp_bucket, dcp_key, dcp_bucket_policy_allow_aws_dcp,
                              logs_bucket, logs_key1, logs_bucket_policy_allow_aws_logs_bucket, user_policy_statments_allow_all)
    checker.check()
    checker.report()
    assert checker.aws_can_list_dcp_bucket == True
    assert checker.aws_cannot_list_dcp_bucket == False
    ...
    checker = S3PolicyChecker(aws_account_arn, user_account_arn, dcp_bucket, dcp_key, dcp_bucket_policy_allow_aws_dcp,
                              logs_bucket, logs_key2, logs_bucket_policy_allow_aws_logs_bucket_key, user_policy_statments_allow_all)
    checker.check()
    checker.report()
    assert checker.aws_can_list_dcp_bucket == True
    assert checker.aws_cannot_list_dcp_bucket == False
