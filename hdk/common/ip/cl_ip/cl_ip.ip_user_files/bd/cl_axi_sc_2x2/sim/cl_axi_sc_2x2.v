...
(* CORE_GENERATION_INFO = "cl_axi_sc_2x2,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=cl_axi_sc_2x2,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=None}" *) (* HW_HANDOFF = "cl_axi_sc_2x2.hwdef" *) 
module cl_axi_sc_2x2
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 DDRB ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DDRB, ADDR_WIDTH 64, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN cl_axi_sc_2x2_aclk_250, DATA_WIDTH 512, FREQ_HZ 250000000, HAS_BRESP 1, HAS_BURST 0, HAS_CACHE 1, HAS_LOCK 0, HAS_PROT 0, HAS_QOS 0, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 64, NUM_READ_OUTSTANDING 32, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 32, NUM_WRITE_THREADS 1, PHASE 0.0, PROTOCOL AXI4, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) output [63:0]DDRB_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ACLK_250 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ACLK_250, ASSOCIATED_BUSIF DDRA:XDMA:ATG:DDRB, ASSOCIATED_RESET aresetn_250, CLK_DOMAIN cl_axi_sc_2x2_aclk_250, FREQ_HZ 250000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input aclk_250;
  ...
  cl_axi_sc_2x2_smartconnect_0_0 smartconnect_0
       (.M00_AXI_araddr(smartconnect_0_M00_AXI_ARADDR),
        ...
        .S00_AXI_araddr(XDMA_1_ARADDR),
        .S00_AXI_arburst(XDMA_1_ARBURST),
        .S00_AXI_arcache(XDMA_1_ARCACHE),
        .S00_AXI_arid(XDMA_1_ARID),
        .S00_AXI_arlen(XDMA_1_ARLEN),
        .S00_AXI_arlock(XDMA_1_ARLOCK),
        .S00_AXI_arprot(XDMA_1_ARPROT),
        .S00_AXI_arqos(XDMA_1_ARQOS),
        .S00_AXI_arready(XDMA_1_ARREADY),
        .S00_AXI_arsize(XDMA_1_ARSIZE),
        .S00_AXI_arvalid(XDMA_1_ARVALID),
        .S00_AXI_awaddr(XDMA_1_AWADDR),
        .S00_AXI_awburst(XDMA_1_AWBURST),
        .S00_AXI_awcache(XDMA_1_AWCACHE),
        .S00_AXI_awid(XDMA_1_AWID),
        .S00_AXI_awlen(XDMA_1_AWLEN),
        .S00_AXI_awlock(XDMA_1_AWLOCK),
        .S00_AXI_awprot(XDMA_1_AWPROT),
        .S00_AXI_awqos(XDMA_1_AWQOS),
        .S00_AXI_awready(XDMA_1_AWREADY),
        .S00_AXI_awsize(XDMA_1_AWSIZE),
        .S00_AXI_awvalid(XDMA_1_AWVALID),
        .S00_AXI_bid(XDMA_1_BID),
        .S00_AXI_bready(XDMA_1_BREADY),
        .S00_AXI_bresp(XDMA_1_BRESP),
        .S00_AXI_bvalid(XDMA_1_BVALID),
        .S00_AXI_rdata(XDMA_1_RDATA),
        .S00_AXI_rid(XDMA_1_RID),
        .S00_AXI_rlast(XDMA_1_RLAST),
        .S00_AXI_rready(XDMA_1_RREADY),
        .S00_AXI_rresp(XDMA_1_RRESP),
        .S00_AXI_rvalid(XDMA_1_RVALID),
        .S00_AXI_wdata(XDMA_1_WDATA),
        .S00_AXI_wlast(XDMA_1_WLAST),
        .S00_AXI_wready(XDMA_1_WREADY),
        .S00_AXI_wstrb(XDMA_1_WSTRB),
        .S00_AXI_wvalid(XDMA_1_WVALID),
        .S01_AXI_araddr(ATG_1_ARADDR),
        .S01_AXI_arburst(ATG_1_ARBURST),
        .S01_AXI_arcache(ATG_1_ARCACHE),
        .S01_AXI_arid(ATG_1_ARID),
        .S01_AXI_arlen(ATG_1_ARLEN),
        .S01_AXI_arlock(ATG_1_ARLOCK),
        .S01_AXI_arprot(ATG_1_ARPROT),
        .S01_AXI_arqos(ATG_1_ARQOS),
        .S01_AXI_arready(ATG_1_ARREADY),
        .S01_AXI_arsize(ATG_1_ARSIZE),
        .S01_AXI_arvalid(ATG_1_ARVALID),
        .S01_AXI_awaddr(ATG_1_AWADDR),
        .S01_AXI_awburst(ATG_1_AWBURST),
        .S01_AXI_awcache(ATG_1_AWCACHE),
        .S01_AXI_awid(ATG_1_AWID),
        .S01_AXI_awlen(ATG_1_AWLEN),
        .S01_AXI_awlock(ATG_1_AWLOCK),
        .S01_AXI_awprot(ATG_1_AWPROT),
        .S01_AXI_awqos(ATG_1_AWQOS),
        .S01_AXI_awready(ATG_1_AWREADY),
        .S01_AXI_awsize(ATG_1_AWSIZE),
        .S01_AXI_awvalid(ATG_1_AWVALID),
        .S01_AXI_bid(ATG_1_BID),
        .S01_AXI_bready(ATG_1_BREADY),
        .S01_AXI_bresp(ATG_1_BRESP),
        .S01_AXI_bvalid(ATG_1_BVALID),
        .S01_AXI_rdata(ATG_1_RDATA),
        .S01_AXI_rid(ATG_1_RID),
        .S01_AXI_rlast(ATG_1_RLAST),
        .S01_AXI_rready(ATG_1_RREADY),
        .S01_AXI_rresp(ATG_1_RRESP),
        .S01_AXI_rvalid(ATG_1_RVALID),
        .S01_AXI_wdata(ATG_1_WDATA),
        .S01_AXI_wlast(ATG_1_WLAST),
        .S01_AXI_wready(ATG_1_WREADY),
        .S01_AXI_wstrb(ATG_1_WSTRB),
        .S01_AXI_wvalid(ATG_1_WVALID),
        .aclk(aclk_0_1),
        .aresetn(aresetn_0_1));
endmodule
