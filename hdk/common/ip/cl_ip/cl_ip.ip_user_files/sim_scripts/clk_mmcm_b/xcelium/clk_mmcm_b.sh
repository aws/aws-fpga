...
#
# Script generated by Vivado on Thu Jul 18 10:54:24 CDT 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : clk_mmcm_b.sh
...
#
# Usage        : clk_mmcm_b.sh
#                clk_mmcm_b.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clk_mmcm_b.sh [-reset_run]
#                clk_mmcm_b.sh [-reset_log]
#                clk_mmcm_b.sh [-help]
#
...
#                script (type 'clk_mmcm_b.sh -help' for more information).
#
...
# script info
echo -e "clk_mmcm_b.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clk_mmcm_b.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.clk_mmcm_b xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.clk_mmcm_b -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log clk_mmcm_b_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./clk_mmcm_b.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: clk_mmcm_b.sh [-help]\n\
Usage: clk_mmcm_b.sh [-step]\n\
Usage: clk_mmcm_b.sh [-lib_map_path]\n\
Usage: clk_mmcm_b.sh [-reset_run]\n\
Usage: clk_mmcm_b.sh [-reset_log]\n\
Usage: clk_mmcm_b.sh [-keep_index]\n\
Usage: clk_mmcm_b.sh [-noclean_files]\n\n\
