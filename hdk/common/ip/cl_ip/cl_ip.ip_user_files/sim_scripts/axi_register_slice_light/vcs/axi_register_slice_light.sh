...
compile()
{
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../cl_ip.gen/sources_1/ip/axi_register_slice_light/hdl" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_axi_register_slice_light/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axi_register_slice_light xil_defaultlib.glbl -o axi_register_slice_light_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axi_register_slice_light_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key axi_register_slice_light_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axi_register_slice_light_simv.daidir vcs_lib c.obj)
