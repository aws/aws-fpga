...
#
# Script generated by Vivado on Thu Jul 18 10:50:49 CDT 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axi_register_slice_light.sh
...
#
# Usage        : axi_register_slice_light.sh
#                axi_register_slice_light.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_register_slice_light.sh [-reset_run]
#                axi_register_slice_light.sh [-reset_log]
#                axi_register_slice_light.sh [-help]
#
...
#                script (type 'axi_register_slice_light.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_31 -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axi_infrastructure_v1_1_0 axi_register_slice_v2_1_31 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "axi_register_slice_light.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_register_slice_light.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/ip/axi_register_slice_light/hdl" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_axi_register_slice_light/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/ip/axi_register_slice_light/hdl" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_axi_register_slice_light/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../cl_ip.gen/sources_1/ip/axi_register_slice_light/hdl" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_axi_register_slice_light/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_31 $xmvlog_opts +incdir+"../../../../cl_ip.gen/sources_1/ip/axi_register_slice_light/hdl" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_axi_register_slice_light/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../cl_ip.gen/sources_1/ip/axi_register_slice_light/hdl" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_axi_register_slice_light/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axi_register_slice_light xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axi_register_slice_light -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axi_register_slice_light_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axi_register_slice_light.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axi_register_slice_light.sh [-help]\n\
Usage: axi_register_slice_light.sh [-step]\n\
Usage: axi_register_slice_light.sh [-lib_map_path]\n\
Usage: axi_register_slice_light.sh [-reset_run]\n\
Usage: axi_register_slice_light.sh [-reset_log]\n\
Usage: axi_register_slice_light.sh [-keep_index]\n\
Usage: axi_register_slice_light.sh [-noclean_files]\n\n\
