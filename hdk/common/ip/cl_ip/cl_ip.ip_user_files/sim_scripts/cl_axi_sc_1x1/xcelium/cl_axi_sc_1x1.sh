...
#
# Script generated by Vivado on Thu Jul 18 12:03:49 CDT 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : cl_axi_sc_1x1.sh
...
#
# Usage        : cl_axi_sc_1x1.sh
#                cl_axi_sc_1x1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                cl_axi_sc_1x1.sh [-reset_run]
#                cl_axi_sc_1x1.sh [-reset_log]
#                cl_axi_sc_1x1.sh [-help]
#
...
#                script (type 'cl_axi_sc_1x1.sh -help' for more information).
#
...
# script info
echo -e "cl_axi_sc_1x1.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./cl_axi_sc_1x1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/bd/cl_axi_sc_1x1/ipshared/f0b6/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/bd/cl_axi_sc_1x1/ipshared/c783/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/bd/cl_axi_sc_1x1/ipshared/ec67/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/bd/cl_axi_sc_1x1/ipshared/f0b6/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/bd/cl_axi_sc_1x1/ipshared/c783/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/bd/cl_axi_sc_1x1/ipshared/ec67/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work xlconstant_v1_1_9 $xmvlog_opts +incdir+"../../../../cl_ip.gen/sources_1/bd/cl_axi_sc_1x1/ipshared/f0b6/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/bd/cl_axi_sc_1x1/ipshared/c783/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/bd/cl_axi_sc_1x1/ipshared/ec67/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../../cl_ip.gen/sources_1/bd/cl_axi_sc_1x1/ipshared/e2d2/hdl/xlconstant_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../cl_ip.gen/sources_1/bd/cl_axi_sc_1x1/ipshared/f0b6/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/bd/cl_axi_sc_1x1/ipshared/c783/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/bd/cl_axi_sc_1x1/ipshared/ec67/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work smartconnect_v1_0 $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/bd/cl_axi_sc_1x1/ipshared/f0b6/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/bd/cl_axi_sc_1x1/ipshared/c783/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/bd/cl_axi_sc_1x1/ipshared/ec67/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/bd/cl_axi_sc_1x1/ipshared/f0b6/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/bd/cl_axi_sc_1x1/ipshared/c783/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/bd/cl_axi_sc_1x1/ipshared/ec67/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../cl_ip.gen/sources_1/bd/cl_axi_sc_1x1/ipshared/f0b6/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/bd/cl_axi_sc_1x1/ipshared/c783/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/bd/cl_axi_sc_1x1/ipshared/ec67/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../../cl_ip.gen/sources_1/bd/cl_axi_sc_1x1/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_31 $xmvlog_opts +incdir+"../../../../cl_ip.gen/sources_1/bd/cl_axi_sc_1x1/ipshared/f0b6/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/bd/cl_axi_sc_1x1/ipshared/c783/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/bd/cl_axi_sc_1x1/ipshared/ec67/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../../cl_ip.gen/sources_1/bd/cl_axi_sc_1x1/ipshared/92b2/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_17 $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/bd/cl_axi_sc_1x1/ipshared/f0b6/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/bd/cl_axi_sc_1x1/ipshared/c783/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/bd/cl_axi_sc_1x1/ipshared/ec67/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.cl_axi_sc_1x1 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.cl_axi_sc_1x1 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log cl_axi_sc_1x1_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./cl_axi_sc_1x1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: cl_axi_sc_1x1.sh [-help]\n\
Usage: cl_axi_sc_1x1.sh [-step]\n\
Usage: cl_axi_sc_1x1.sh [-lib_map_path]\n\
Usage: cl_axi_sc_1x1.sh [-reset_run]\n\
Usage: cl_axi_sc_1x1.sh [-reset_log]\n\
Usage: cl_axi_sc_1x1.sh [-keep_index]\n\
Usage: cl_axi_sc_1x1.sh [-noclean_files]\n\n\
