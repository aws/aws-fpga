...
#
# Script generated by Vivado on Tue Oct 29 16:04:10 CDT 2024
...
#
# Usage        : cl_hbm.sh
#                cl_hbm.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                cl_hbm.sh [-reset_run]
#                cl_hbm.sh [-reset_log]
#                cl_hbm.sh [-help]
#
...
#                script (type 'cl_hbm.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname xil_defaultlib -libname hbm_v1_0_16 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm xil_defaultlib hbm_v1_0_16)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "cl_hbm.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./cl_hbm.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_hbm/hdl/rtl" +incdir+"../../../ipstatic/verif/model" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_hbm/hdl/rtl" +incdir+"../../../ipstatic/verif/model" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_hbm/hdl/rtl" +incdir+"../../../ipstatic/verif/model" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../../cl_ip.gen/sources_1/ip/cl_hbm/hdl/rtl/hbm_v1_0_16.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work hbm_v1_0_16 $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_hbm/hdl/rtl" +incdir+"../../../ipstatic/verif/model" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.cl_hbm xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.cl_hbm -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log cl_hbm_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./cl_hbm.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: cl_hbm.sh [-help]\n\
Usage: cl_hbm.sh [-step]\n\
Usage: cl_hbm.sh [-lib_map_path]\n\
Usage: cl_hbm.sh [-reset_run]\n\
Usage: cl_hbm.sh [-reset_log]\n\
Usage: cl_hbm.sh [-keep_index]\n\
Usage: cl_hbm.sh [-noclean_files]\n\n\
