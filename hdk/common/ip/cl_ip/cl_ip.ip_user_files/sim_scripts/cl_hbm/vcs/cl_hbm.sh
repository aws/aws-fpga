...
design_libs=(xilinx_vip xpm xil_defaultlib hbm_v1_0_16)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_hbm/hdl/rtl" +incdir+"../../../ipstatic/verif/model" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_hbm/hdl/rtl" +incdir+"../../../ipstatic/verif/model" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_hbm/hdl/rtl" +incdir+"../../../ipstatic/verif/model" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../../cl_ip.gen/sources_1/ip/cl_hbm/hdl/rtl/hbm_v1_0_16.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work hbm_v1_0_16 $vlogan_opts -sverilog +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_hbm/hdl/rtl" +incdir+"../../../ipstatic/verif/model" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.cl_hbm xil_defaultlib.glbl -o cl_hbm_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./cl_hbm_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key cl_hbm_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc cl_hbm_simv.daidir vcs_lib c.obj)
