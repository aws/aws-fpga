...
#
# Script generated by Vivado on Thu Jul 18 10:51:39 CDT 2024
...
#
# Usage        : cl_axi_interconnect.sh
#                cl_axi_interconnect.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                cl_axi_interconnect.sh [-reset_run]
#                cl_axi_interconnect.sh [-reset_log]
#                cl_axi_interconnect.sh [-help]
#
...
#                script (type 'cl_axi_interconnect.sh -help' for more information).
#
...
# script info
echo -e "cl_axi_interconnect.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./cl_axi_interconnect.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.cl_axi_interconnect xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.cl_axi_interconnect -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log cl_axi_interconnect_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: cl_axi_interconnect.sh [-step]\n\
Usage: cl_axi_interconnect.sh [-lib_map_path]\n\
Usage: cl_axi_interconnect.sh [-reset_run]\n\
Usage: cl_axi_interconnect.sh [-reset_log]\n\
Usage: cl_axi_interconnect.sh [-keep_index]\n\
