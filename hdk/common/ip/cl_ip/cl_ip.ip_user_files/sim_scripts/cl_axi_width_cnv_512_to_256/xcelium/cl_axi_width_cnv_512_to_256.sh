...
#
# Script generated by Vivado on Thu Jul 18 10:52:21 CDT 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : cl_axi_width_cnv_512_to_256.sh
...
#
# Usage        : cl_axi_width_cnv_512_to_256.sh
#                cl_axi_width_cnv_512_to_256.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                cl_axi_width_cnv_512_to_256.sh [-reset_run]
#                cl_axi_width_cnv_512_to_256.sh [-reset_log]
#                cl_axi_width_cnv_512_to_256.sh [-help]
#
...
#                script (type 'cl_axi_width_cnv_512_to_256.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname generic_baseblocks_v2_1_2 -libname fifo_generator_v13_2_10 -libname axi_data_fifo_v2_1_30 -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_31 -libname axi_protocol_converter_v2_1_31 -libname axi_clock_converter_v2_1_30 -libname blk_mem_gen_v8_4_8 -libname axi_dwidth_converter_v2_1_31 -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm generic_baseblocks_v2_1_2 fifo_generator_v13_2_10 axi_data_fifo_v2_1_30 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_31 axi_protocol_converter_v2_1_31 axi_clock_converter_v2_1_30 blk_mem_gen_v8_4_8 axi_dwidth_converter_v2_1_31 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "cl_axi_width_cnv_512_to_256.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./cl_axi_width_cnv_512_to_256.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work generic_baseblocks_v2_1_2 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work fifo_generator_v13_2_10 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_data_fifo_v2_1_30 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_31 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_protocol_converter_v2_1_31 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_protocol_converter_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_clock_converter_v2_1_30 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_clock_converter_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work blk_mem_gen_v8_4_8 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_dwidth_converter_v2_1_31 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_dwidth_converter_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.cl_axi_width_cnv_512_to_256 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.cl_axi_width_cnv_512_to_256 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log cl_axi_width_cnv_512_to_256_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./cl_axi_width_cnv_512_to_256.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: cl_axi_width_cnv_512_to_256.sh [-help]\n\
Usage: cl_axi_width_cnv_512_to_256.sh [-step]\n\
Usage: cl_axi_width_cnv_512_to_256.sh [-lib_map_path]\n\
Usage: cl_axi_width_cnv_512_to_256.sh [-reset_run]\n\
Usage: cl_axi_width_cnv_512_to_256.sh [-reset_log]\n\
Usage: cl_axi_width_cnv_512_to_256.sh [-keep_index]\n\
Usage: cl_axi_width_cnv_512_to_256.sh [-noclean_files]\n\n\
