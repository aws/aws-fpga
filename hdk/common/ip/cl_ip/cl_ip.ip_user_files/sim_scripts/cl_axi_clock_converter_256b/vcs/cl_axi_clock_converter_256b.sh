...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.cl_axi_clock_converter_256b xil_defaultlib.glbl -o cl_axi_clock_converter_256b_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./cl_axi_clock_converter_256b_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key cl_axi_clock_converter_256b_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc cl_axi_clock_converter_256b_simv.daidir vcs_lib c.obj)
