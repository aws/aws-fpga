...
#                script (type 'axi_register_slice.sh -help' for more information).
#
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/ip/axi_register_slice/hdl" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_axi_register_slice/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/ip/axi_register_slice/hdl" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_axi_register_slice/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../cl_ip.gen/sources_1/ip/axi_register_slice/hdl" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_axi_register_slice/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_31 $xmvlog_opts +incdir+"../../../../cl_ip.gen/sources_1/ip/axi_register_slice/hdl" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_axi_register_slice/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../cl_ip.gen/sources_1/ip/axi_register_slice/hdl" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_axi_register_slice/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axi_register_slice xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axi_register_slice -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axi_register_slice_sc.so .tmp_log xcelium_lib waves.shm c.obj)
