...
#
# Script generated by Vivado on Thu Jul 18 10:53:37 CDT 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : cl_debug_bridge.sh
...
#
# Usage        : cl_debug_bridge.sh
#                cl_debug_bridge.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                cl_debug_bridge.sh [-reset_run]
#                cl_debug_bridge.sh [-reset_log]
#                cl_debug_bridge.sh [-help]
#
...
#                script (type 'cl_debug_bridge.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname xsdbm_v3_0_2 -libname xil_defaultlib -libname lut_buffer_v2_0_1 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm xsdbm_v3_0_2 xil_defaultlib lut_buffer_v2_0_1)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "cl_debug_bridge.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./cl_debug_bridge.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_debug_bridge/bd_0/ip/ip_0/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_debug_bridge/bd_0/ip/ip_0/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work xsdbm_v3_0_2 $xmvlog_opts +incdir+"../../../ipstatic/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_debug_bridge/bd_0/ip/ip_0/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/xsdbm_v3_0_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../ipstatic/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_debug_bridge/bd_0/ip/ip_0/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../../cl_ip.gen/sources_1/ip/cl_debug_bridge/bd_0/ip/ip_0/sim/bd_a493_xsdbm_0.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work lut_buffer_v2_0_1 $xmvlog_opts +incdir+"../../../ipstatic/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_debug_bridge/bd_0/ip/ip_0/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.cl_debug_bridge xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.cl_debug_bridge -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log cl_debug_bridge_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./cl_debug_bridge.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: cl_debug_bridge.sh [-help]\n\
Usage: cl_debug_bridge.sh [-step]\n\
Usage: cl_debug_bridge.sh [-lib_map_path]\n\
Usage: cl_debug_bridge.sh [-reset_run]\n\
Usage: cl_debug_bridge.sh [-reset_log]\n\
Usage: cl_debug_bridge.sh [-keep_index]\n\
Usage: cl_debug_bridge.sh [-noclean_files]\n\n\
