...
#
# Script generated by Vivado on Thu Jul 18 10:54:59 CDT 2024
...
#
# Usage        : ila_1.sh
#                ila_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ila_1.sh [-reset_run]
#                ila_1.sh [-reset_log]
#                ila_1.sh [-help]
#
...
#                script (type 'ila_1.sh -help' for more information).
#
...
# script info
echo -e "ila_1.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ila_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/ip/ila_1/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/ip/ila_1/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../cl_ip.gen/sources_1/ip/ila_1/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ila_1 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ila_1 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ila_1_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: ila_1.sh [-reset_log]\n\
Usage: ila_1.sh [-keep_index]\n\
