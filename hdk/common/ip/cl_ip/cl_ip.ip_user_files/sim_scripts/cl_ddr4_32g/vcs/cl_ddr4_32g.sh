...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/ip_1/rtl/map" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/rtl/ip_top" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/rtl/cal" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/ip_1/rtl/map" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/rtl/ip_top" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/rtl/cal" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.cl_ddr4_32g xil_defaultlib.glbl -o cl_ddr4_32g_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./cl_ddr4_32g_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key cl_ddr4_32g_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc cl_ddr4_32g_simv.daidir vcs_lib c.obj)
