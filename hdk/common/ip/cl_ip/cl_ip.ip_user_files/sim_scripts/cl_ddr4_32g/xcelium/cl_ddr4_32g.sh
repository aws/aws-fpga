...
#
# Script generated by Vivado on Thu Jul 18 10:52:59 CDT 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : cl_ddr4_32g.sh
...
#
# Usage        : cl_ddr4_32g.sh
#                cl_ddr4_32g.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                cl_ddr4_32g.sh [-reset_run]
#                cl_ddr4_32g.sh [-reset_log]
#                cl_ddr4_32g.sh [-help]
#
...
#                script (type 'cl_ddr4_32g.sh -help' for more information).
#
...
# script info
echo -e "cl_ddr4_32g.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./cl_ddr4_32g.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/ip_1/rtl/map" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/rtl/ip_top" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/rtl/cal" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/ip_1/rtl/map" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/rtl/ip_top" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/rtl/cal" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work blk_mem_gen_v8_4_8 $xmvlog_opts +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/ip_1/rtl/map" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/rtl/ip_top" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/rtl/cal" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/ip_1/rtl/map" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/rtl/ip_top" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/rtl/cal" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/ip_1/rtl/map" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/rtl/ip_top" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/rtl/cal" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.cl_ddr4_32g xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.cl_ddr4_32g -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log cl_ddr4_32g_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./cl_ddr4_32g.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: cl_ddr4_32g.sh [-help]\n\
Usage: cl_ddr4_32g.sh [-step]\n\
Usage: cl_ddr4_32g.sh [-lib_map_path]\n\
Usage: cl_ddr4_32g.sh [-reset_run]\n\
Usage: cl_ddr4_32g.sh [-reset_log]\n\
Usage: cl_ddr4_32g.sh [-keep_index]\n\
Usage: cl_ddr4_32g.sh [-noclean_files]\n\n\
