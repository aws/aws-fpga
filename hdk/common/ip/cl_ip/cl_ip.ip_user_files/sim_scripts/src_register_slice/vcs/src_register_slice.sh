...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.src_register_slice xil_defaultlib.glbl -o src_register_slice_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./src_register_slice_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key src_register_slice_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc src_register_slice_simv.daidir vcs_lib c.obj)
