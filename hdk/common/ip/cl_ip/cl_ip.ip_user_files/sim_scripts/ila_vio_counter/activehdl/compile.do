...
vlog -work xpm  -sv2k12 "+incdir+../../../../cl_ip.gen/sources_1/ip/ila_vio_counter/hdl/verilog" "+incdir+$XILINX_VIVADO/data/xilinx_vip/include" -l xilinx_vip -l xpm -l xil_defaultlib \
...
vlog -work xil_defaultlib  -v2k5 "+incdir+../../../../cl_ip.gen/sources_1/ip/ila_vio_counter/hdl/verilog" "+incdir+$XILINX_VIVADO/data/xilinx_vip/include" -l xilinx_vip -l xpm -l xil_defaultlib \
