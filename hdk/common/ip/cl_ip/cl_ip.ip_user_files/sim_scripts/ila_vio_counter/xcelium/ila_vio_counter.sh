...
#
# Script generated by Vivado on Thu Jul 18 10:55:19 CDT 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ila_vio_counter.sh
...
#
# Usage        : ila_vio_counter.sh
#                ila_vio_counter.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ila_vio_counter.sh [-reset_run]
#                ila_vio_counter.sh [-reset_log]
#                ila_vio_counter.sh [-help]
#
...
#                script (type 'ila_vio_counter.sh -help' for more information).
#
...
# script info
echo -e "ila_vio_counter.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ila_vio_counter.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/ip/ila_vio_counter/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/ip/ila_vio_counter/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../cl_ip.gen/sources_1/ip/ila_vio_counter/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ila_vio_counter xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ila_vio_counter -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ila_vio_counter_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ila_vio_counter.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ila_vio_counter.sh [-help]\n\
Usage: ila_vio_counter.sh [-step]\n\
Usage: ila_vio_counter.sh [-lib_map_path]\n\
Usage: ila_vio_counter.sh [-reset_run]\n\
Usage: ila_vio_counter.sh [-reset_log]\n\
Usage: ila_vio_counter.sh [-keep_index]\n\
Usage: ila_vio_counter.sh [-noclean_files]\n\n\
