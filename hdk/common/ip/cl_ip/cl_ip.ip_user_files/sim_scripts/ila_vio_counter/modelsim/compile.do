...
vlog -work xpm -64 -incr -mfcu  -sv -L axi_vip_v1_1_17 -L smartconnect_v1_0 -L hbm_v1_0_16 -L xdma_v4_1_29 -L xilinx_vip "+incdir+../../../../cl_ip.gen/sources_1/ip/ila_vio_counter/hdl/verilog" "+incdir+$XILINX_VIVADO/data/xilinx_vip/include" \
...
vlog -work xil_defaultlib -64 -incr -mfcu  "+incdir+../../../../cl_ip.gen/sources_1/ip/ila_vio_counter/hdl/verilog" "+incdir+$XILINX_VIVADO/data/xilinx_vip/include" \
