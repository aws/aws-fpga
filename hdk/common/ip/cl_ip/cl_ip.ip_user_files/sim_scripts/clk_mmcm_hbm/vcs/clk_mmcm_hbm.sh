...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.clk_mmcm_hbm xil_defaultlib.glbl -o clk_mmcm_hbm_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./clk_mmcm_hbm_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key clk_mmcm_hbm_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc clk_mmcm_hbm_simv.daidir vcs_lib c.obj)
