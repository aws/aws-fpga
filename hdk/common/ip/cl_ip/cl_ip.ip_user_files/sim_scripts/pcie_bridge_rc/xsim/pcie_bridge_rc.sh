...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_17 -L smartconnect_v1_0 -L hbm_v1_0_16 -L xdma_v4_1_29 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L gtwizard_ultrascale_v1_7_18 -L xil_defaultlib -L blk_mem_gen_v8_4_8 -L xdma_v4_1_29 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot pcie_bridge_rc xil_defaultlib.pcie_bridge_rc xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim pcie_bridge_rc -key {Behavioral:sim_1:Functional:pcie_bridge_rc} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_6722.protoinst" -protoinst "protoinst_files/cl_axi_sc_1x1.protoinst" -protoinst "protoinst_files/bd_2e02.protoinst" -protoinst "protoinst_files/bd_a493.protoinst" -protoinst "protoinst_files/bd_9c5e.protoinst" -protoinst "protoinst_files/bd_c5ad.protoinst" -protoinst "protoinst_files/bd_1535.protoinst" -protoinst "protoinst_files/bd_1096.protoinst" -protoinst "protoinst_files/cl_axi_sc_2x2.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb pcie_bridge_rc.wdb xsim.dir libdpi.so)
