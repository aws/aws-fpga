...
#
# Script generated by Vivado on Thu Jul 18 10:56:07 CDT 2024
...
#
# Usage        : vio_0.sh
#                vio_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                vio_0.sh [-reset_run]
#                vio_0.sh [-reset_log]
#                vio_0.sh [-help]
#
...
#                script (type 'vio_0.sh -help' for more information).
#
...
# script info
echo -e "vio_0.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./vio_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/ip/vio_0/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/ip/vio_0/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/ip/vio_0/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/ip/vio_0/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../cl_ip.gen/sources_1/ip/vio_0/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/ip/vio_0/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.vio_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.vio_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log vio_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: vio_0.sh [-reset_log]\n\
Usage: vio_0.sh [-keep_index]\n\
