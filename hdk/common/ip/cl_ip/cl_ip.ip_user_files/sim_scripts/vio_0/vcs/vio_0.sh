...
compile()
{
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../cl_ip.gen/sources_1/ip/vio_0/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/ip/vio_0/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
...
reset_run()
{
  files_to_remove=(ucli.key vio_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc vio_0_simv.daidir vcs_lib c.obj)
