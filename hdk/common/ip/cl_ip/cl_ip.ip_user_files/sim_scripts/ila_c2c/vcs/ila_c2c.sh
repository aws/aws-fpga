...
compile()
{
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../cl_ip.gen/sources_1/ip/ila_c2c/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ila_c2c xil_defaultlib.glbl -o ila_c2c_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ila_c2c_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ila_c2c_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ila_c2c_simv.daidir vcs_lib c.obj)
