...
#
# Script generated by Vivado on Thu Jul 18 10:50:58 CDT 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : cl_axi3_256b_reg_slice.sh
...
#
# Usage        : cl_axi3_256b_reg_slice.sh
#                cl_axi3_256b_reg_slice.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                cl_axi3_256b_reg_slice.sh [-reset_run]
#                cl_axi3_256b_reg_slice.sh [-reset_log]
#                cl_axi3_256b_reg_slice.sh [-help]
#
...
#                script (type 'cl_axi3_256b_reg_slice.sh -help' for more information).
#
...
# script info
echo -e "cl_axi3_256b_reg_slice.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./cl_axi3_256b_reg_slice.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.cl_axi3_256b_reg_slice xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.cl_axi3_256b_reg_slice -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log cl_axi3_256b_reg_slice_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./cl_axi3_256b_reg_slice.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: cl_axi3_256b_reg_slice.sh [-help]\n\
Usage: cl_axi3_256b_reg_slice.sh [-step]\n\
Usage: cl_axi3_256b_reg_slice.sh [-lib_map_path]\n\
Usage: cl_axi3_256b_reg_slice.sh [-reset_run]\n\
Usage: cl_axi3_256b_reg_slice.sh [-reset_log]\n\
Usage: cl_axi3_256b_reg_slice.sh [-keep_index]\n\
Usage: cl_axi3_256b_reg_slice.sh [-noclean_files]\n\n\
