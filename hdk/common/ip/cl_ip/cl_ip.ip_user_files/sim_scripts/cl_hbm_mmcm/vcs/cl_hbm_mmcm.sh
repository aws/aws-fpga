...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.cl_hbm_mmcm xil_defaultlib.glbl -o cl_hbm_mmcm_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./cl_hbm_mmcm_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key cl_hbm_mmcm_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc cl_hbm_mmcm_simv.daidir vcs_lib c.obj)
