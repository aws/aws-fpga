...
#
# Script generated by Vivado on Thu Jul 18 10:55:30 CDT 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : pcie_bridge_ep.sh
...
#
# Usage        : pcie_bridge_ep.sh
#                pcie_bridge_ep.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                pcie_bridge_ep.sh [-reset_run]
#                pcie_bridge_ep.sh [-reset_log]
#                pcie_bridge_ep.sh [-help]
#
...
#                script (type 'pcie_bridge_ep.sh -help' for more information).
#
...
# script info
echo -e "pcie_bridge_ep.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./pcie_bridge_ep.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/ip/pcie_bridge_ep/ip_0/source" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/ip/pcie_bridge_ep/ip_0/source" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work gtwizard_ultrascale_v1_7_18 $xmvlog_opts +incdir+"../../../../cl_ip.gen/sources_1/ip/pcie_bridge_ep/ip_0/source" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../cl_ip.gen/sources_1/ip/pcie_bridge_ep/ip_0/source" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work blk_mem_gen_v8_4_8 $xmvlog_opts +incdir+"../../../../cl_ip.gen/sources_1/ip/pcie_bridge_ep/ip_0/source" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work xdma_v4_1_29 $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/ip/pcie_bridge_ep/ip_0/source" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/xdma_v4_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/ip/pcie_bridge_ep/ip_0/source" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.pcie_bridge_ep xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.pcie_bridge_ep -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log pcie_bridge_ep_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./pcie_bridge_ep.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: pcie_bridge_ep.sh [-help]\n\
Usage: pcie_bridge_ep.sh [-step]\n\
Usage: pcie_bridge_ep.sh [-lib_map_path]\n\
Usage: pcie_bridge_ep.sh [-reset_run]\n\
Usage: pcie_bridge_ep.sh [-reset_log]\n\
Usage: pcie_bridge_ep.sh [-keep_index]\n\
Usage: pcie_bridge_ep.sh [-noclean_files]\n\n\
