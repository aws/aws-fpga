...
compile()
{
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../cl_ip.gen/sources_1/ip/pcie_bridge_ep/ip_0/source" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"../../../../cl_ip.gen/sources_1/ip/pcie_bridge_ep/ip_0/source" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.pcie_bridge_ep xil_defaultlib.glbl -o pcie_bridge_ep_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./pcie_bridge_ep_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key pcie_bridge_ep_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc pcie_bridge_ep_simv.daidir vcs_lib c.obj)
