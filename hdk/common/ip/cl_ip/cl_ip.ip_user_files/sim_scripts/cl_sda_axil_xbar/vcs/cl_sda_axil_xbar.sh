...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.cl_sda_axil_xbar xil_defaultlib.glbl -o cl_sda_axil_xbar_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./cl_sda_axil_xbar_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key cl_sda_axil_xbar_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc cl_sda_axil_xbar_simv.daidir vcs_lib c.obj)
