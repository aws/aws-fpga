...
class TestLoadAfi(AwsFpgaTestBase):
    ...
    def base_test(self, cl, agfi, afi, install_edma_driver, slots_to_test, option_tag):
    ...
    def test_cl_dram_dma(self):
        cl = 'cl_dram_dma'
        self.base_fdf_test(cl, install_edma_driver=True)
    ...
    def test_cl_uram_example_uram_option_2(self):
        cl = 'cl_uram_example'
        self.base_fdf_test(cl, install_edma_driver=False, option_tag='uram_option_2')
    
    def test_cl_uram_example_uram_option_3(self):
        cl = 'cl_uram_example'
        self.base_fdf_test(cl, install_edma_driver=False, option_tag='uram_option_3')
    
    def test_cl_uram_example_uram_option_4(self):
        cl = 'cl_uram_example'
        self.base_fdf_test(cl, install_edma_driver=False, option_tag='uram_option_4')
