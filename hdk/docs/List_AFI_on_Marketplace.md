...
2. Prepare your solution:
   - Create your AFI using the supported workflows in the [AWS FPGA Developer Kit](./../README.md#build-accelerator-afi-using-hdk-design-flow)
   - Build an [AMI](https://docs.aws.amazon.com/marketplace/latest/userguide/ami-products.html) that includes all required software components:
     * Device drivers
     * Runtime engines
     * Libraries
     * Documentation
...
3. Initiate AMI scanning via the [AMI Scanning page](https://docs.aws.amazon.com/marketplace/latest/userguide/product-and-ami-policies.html#security).
...
1. Follow the [process](https://docs.aws.amazon.com/marketplace/latest/userguide/product-submission.html) for submitting your product for publication
...
For detailed information about AWS Marketplace policies and best practices, visit the [AWS Marketplace Seller Guide](https://docs.aws.amazon.com/marketplace/latest/userguide/what-is-marketplace.html).
