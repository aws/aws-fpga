...
You can follow the [build scripts readme](./common/shell_v04261818/new_cl_template/build/README.md) for step-by-step instructions on how to setup the scripts and run the build process.
