 ...
 */
//--------------------------------------------------------------------------------------
// Dynamically configure clock frequencies using AWS_CLK_GEN block
...
int main(int argc, char **argv) {
    ...
    printf("__INFO__: Dynamic config clk_extra_a1 = %d MHz, clk_extra_b0 = %d MHz, clk_extra_c0 = %d MHz, clk_hbm_axi = %d MHz\n", freq_a, freq_b, freq_c, freq_hbm);
    rc = aws_clkgen_set_dynamic(slot_id, freq_a, freq_b, freq_c, freq_hbm, 0);
    fail_on(rc, out, "aws_clkgen_set_dynamic()");
    ...
    printf("__INFO__: Resetting all MMCMs to default frequencies\n");
    rc = aws_clkgen_set_dynamic(slot_id, 0, 0, 0, 0, 1);
    fail_on(rc, out, "aws_clkgen_set_dynamic()");
