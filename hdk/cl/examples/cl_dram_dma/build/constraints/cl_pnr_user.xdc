...
add_cells_to_pblock [get_pblocks pblock_CL_top] -cells [get_cells -quiet -hierarchical -filter {NAME =~ CL/CL_DMA_PCIS_SLV/CL_TST_DDR_A*}]
add_cells_to_pblock [get_pblocks pblock_CL_top] -cells [get_cells -quiet -hierarchical -filter {NAME =~ CL/CL_DMA_PCIS_SLV/DDR_A_TST_AXI4_REG_SLC_2*}]
...
add_cells_to_pblock [get_pblocks pblock_CL_bot] -cells [get_cells -quiet -hierarchical -filter {NAME =~ CL/CL_DMA_PCIS_SLV/CL_TST_DDR_D*}]
add_cells_to_pblock [get_pblocks pblock_CL_bot] -cells [get_cells -quiet -hierarchical -filter {NAME =~ CL/CL_DMA_PCIS_SLV/DDR_D_TST_AXI4_REG_SLC_2*}]
...
add_cells_to_pblock [get_pblocks pblock_CL_mid] -cells [get_cells -quiet -hierarchical -filter {NAME =~ CL/CL_DMA_PCIS_SLV/CL_TST_DDR_B*}]
add_cells_to_pblock [get_pblocks pblock_CL_mid] -cells [get_cells -quiet -hierarchical -filter {NAME =~ CL/CL_DMA_PCIS_SLV/DDR_A_TST_AXI4_REG_SLC_1*}]
add_cells_to_pblock [get_pblocks pblock_CL_mid] -cells [get_cells -quiet -hierarchical -filter {NAME =~ CL/CL_DMA_PCIS_SLV/DDR_B_TST_AXI4_REG_SLC_1*}]
add_cells_to_pblock [get_pblocks pblock_CL_mid] -cells [get_cells -quiet -hierarchical -filter {NAME =~ CL/CL_DMA_PCIS_SLV/DDR_D_TST_AXI4_REG_SLC_1*}]
add_cells_to_pblock [get_pblocks pblock_CL_mid] -cells [get_cells -quiet -hierarchical -filter {NAME =~ CL/CL_DMA_PCIS_SLV/DDR_B_TST_AXI4_REG_SLC_2*}]
...
add_cells_to_pblock [get_pblocks pblock_CL_mid] -cells [get_cells -quiet -hierarchical -filter {NAME =~ CL/CL_DMA_PCIS_SLV/CL_TST_DDR_C}]
add_cells_to_pblock [get_pblocks pblock_CL_mid] -cells [get_cells -quiet -hierarchical -filter {NAME =~ CL/CL_DMA_PCIS_SLV/DDR_C_TST_AXI4_REG_SLC}]
add_cells_to_pblock [get_pblocks pblock_CL_mid] -cells [get_cells -quiet -hierarchical -filter {NAME =~ CL/CL_DMA_PCIS_SLV/DDR_C_TST_AXI4_REG_SLC_1}]
