...
add_cells_to_pblock [get_pblocks pblock_CL_mid] [get_cells [list \
                                                                WRAPPER_INST/CL/CL_DMA_PCIS_SLV/PCI_AXL_REG_SLC \
                                                                WRAPPER_INST/CL/CL_OCL_SLV/AXIL_OCL_REG_SLC \
                                                                WRAPPER_INST/CL/CL_SDA_SLV/AXIL_SDA_REG_SLC \
                                                               ]]
#add_cells_to_pblock [get_pblocks pblock_CL_mid] [get_cells -hierarchical -filter { NAME =~  "*CL/CL_OCL_SLV/slv_tst_wdata_reg[*][*]*" && PRIMITIVE_TYPE =~ REGISTER.*.* }]
...
add_cells_to_pblock [get_pblocks pblock_CL_bot] [get_cells -quiet -hierarchical -filter {NAME =~ WRAPPER_INST/CL/CL_PCIM_MSTR/CL_TST_PCI}] -clear_locs
add_cells_to_pblock [get_pblocks pblock_CL_bot] [get_cells [list WRAPPER_INST/CL/CL_PCIM_MSTR/PCI_AXI4_REG_SLC]]
