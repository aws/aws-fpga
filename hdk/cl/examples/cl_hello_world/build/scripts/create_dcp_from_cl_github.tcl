...
set RTL_ORIGIN_TOP    ../../../../../top/vu9p/design
set RTL_ORIGIN_COMMON ../../../../../common/design
set RTL_ORIGIN_CL     ../../design/cl
...
read_verilog [ list \
$RTL_ORIGIN_COMMON/lib/flop_fifo.sv \
$RTL_ORIGIN_COMMON/lib/flop_fifo_in.sv \
$RTL_ORIGIN_COMMON/lib/bram_2rw.sv \
$RTL_ORIGIN_COMMON/lib/flop_ccf.sv \
$RTL_ORIGIN_COMMON/lib/ccf_ctl.v \
$RTL_ORIGIN_COMMON/lib/sync.v \
$RTL_ORIGIN_COMMON/lib/axi4_ccf.sv \
$RTL_ORIGIN_COMMON/lib/axi4_flop_fifo.sv \
$RTL_ORIGIN_COMMON/lib/lib_pipe.sv \
$RTL_ORIGIN_TOP/mgt/mgt_acc_ccf.sv \
$RTL_ORIGIN_TOP/mgt/mgt_acc_axl.sv  \
$RTL_ORIGIN_TOP/mgt/mgt_gen_axl.sv  \
$RTL_ORIGIN_CL/cl/cl_ports.vh \
$RTL_ORIGIN_TOP/sh/sh_ddr.sv
]

#Read DDR IP
read_ip {
$RTL_ORIGIN_TOP/v3_venom_cl/v3_venom_cl.srcs/sources_1/ip/ddr4_core/ddr4_core.xci
}
