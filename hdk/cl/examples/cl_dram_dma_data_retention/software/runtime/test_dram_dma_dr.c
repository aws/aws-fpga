...
int main(int argc, char **argv) {
    ...
    rc = dma_data_retention_example(slot_id);
    fail_on(rc, out, "DMA Data Retention example failed");
...
int dma_data_retention_example(int slot_id) {
    ...
    /*Load AFI with the 1.4 Shell*/
    system("sudo fpga-load-local-image -S 0 -I agfi-087e7e9d702cb67cc");
    ...
    /*Loading a different AFI with the 1.4 Shell and checking to make sure that the data from the previous AFI was retained*/
    system("sudo fpga-load-local-image -S 0 -I agfi-04be50f23730a96fe");
