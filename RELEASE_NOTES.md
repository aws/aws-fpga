...
The AWS [FPGA Development Forum](https://forums.aws.amazon.com/forum.jspa?forumID=243&start=0) provides an easy access to Developer support.  The FPGA development user forum is the first place to go to post questions, suggestions and receive important announcements. To be notified on important messages you will need to click the “Watch Forum” button on the right side of the screen.
