...
## Release 1.3.9 (See [ERRATA](./ERRATA.md) for unsupported features)		 
* HLX Flow Fixes 
* Updated SDK, Edma, XDMA & XOCL drivers to work with linux kernels greater than  3.10.0-862.3.3.el7.x86_64.

## Release 1.3.8 (See [ERRATA](./ERRATA.md) for unsupported features)
* Fixed SDAccel XOCL driver compile fails that occur on linux kernel greater than 3.10.0-693.21.1.el7.x86_64 
