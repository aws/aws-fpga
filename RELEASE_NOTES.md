...
17.	Updated CL_HELLO_WORLD Example
    ...
    * Add support for 32-bit peek/poke via ocl AXI-L bus
...
18.	Added CL_DRAM_DMA Example
    ...
    * Demonstrate the use of bar1 AXI-L bus
...
**Can I use my AFIs from the Private Preview with the new HDK release?**
...
The AWS Forum FPGA Development provides an easy access to Developer support.  The [FPGA development user forum](https://forums.aws.amazon.com/index.jspa) is the first place to go to post questions, suggestions and receive important announcements. Once logged in, to be notified on important messages and/or posts, you will need to click the “Watch Forum" button on the right side of the screen.
