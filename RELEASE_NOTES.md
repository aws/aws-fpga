...
* shell_version, pci_vendor_id, pci_device_id are now a mandatory parameter in manifest.txt that should be submitted within the tar file
...
* Clock frequency selection is set when calling `create-fpga-image`, through the manifest.txt that includes the clock_group_profile data.  
