...
The following examples do not support Hardware Emulation runtime simulation.
...
For this tool version, the following designs do not meet timing and have reduced HBM clock speeds:
