            ...
            node(task_label.get('find_tests')) {
                ...
                for ( def e in entrySet(example_map) ) {
                    ...
                    for ( def dsa in entrySet(dsa_map) ) {
                        ...
                        String sw_emu_stage_name      = "SDAccel SW_EMU ${build_name} ${dsa_name} FDF"
                        String hw_emu_stage_name      = "SDAccel HW_EMU ${build_name} ${dsa_name} FDF"
                        String hw_stage_name          = "SDAccel HW ${build_name} ${dsa_name} FDF"
                        String create_afi_stage_name  = "SDAccel AFI ${build_name} ${dsa_name} FDF"
                        String run_example_stage_name = "SDAccel RUN ${build_name} ${dsa_name} FDF"
      
                        String sw_emu_report_file      = "sdaccel_sw_emu_${build_name}_${dsa_name}.xml"
                        String hw_emu_report_file      = "sdaccel_hw_emu_${build_name}_${dsa_name}.xml"
                        String hw_report_file          = "sdaccel_hw_${build_name}_${dsa_name}.xml"
                        String create_afi_report_file  = "sdaccel_create_afi_${build_name}_${dsa_name}.xml"
                        String run_example_report_file = "sdaccel_run_${build_name}_${dsa_name}.xml"
